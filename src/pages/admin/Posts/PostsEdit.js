...
import { getPost as apiGetPost, updatePost as apiUpdatePost } from "../../../services/postService"
...
const EditPostsPage = ({ data }) => {
	...
	useEffect(() => {
		...
		form.addEventListener("submit", async (e) => {
			...
			try {
				await schema.validate(newPost, { abortEarly: false })
						...
						<div class="row">
							<div class="col-12">
								<input
									...
									type="text"
									placeholder="Tiêu Đề"
									value="${getLocalStorage("POST")?.title}"
								/>
							...
							<div class="col-12">
								...
								>
${getLocalStorage("POST")?.content}</textarea
								>
